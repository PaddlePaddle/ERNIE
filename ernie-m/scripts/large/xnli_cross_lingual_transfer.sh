...
distributed_args="--node_ips $(hostname -i) --node_id 0 --current_node_ip $(hostname -i) --log_prefix xnli_ --nproc_per_node 2 --selected_gpus 0,1"
python -u ./launch.py ${distributed_args} \
   ...
   --in_tokens false \
   --batch_size 16 \
   --train_set ./data/xnli/train/train.en.tsv \
