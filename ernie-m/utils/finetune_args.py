...
train_g.add_arg("layerwise_lr_decay",      float,  0.9,    "Layerwise LR decay")
...
data_g.add_arg("lang_map_config",    str,  None,  "lang_map_path.")
...
run_type_g.add_arg("use_gpu_num_in_test",  int,  2,  "use gpu number in test phase")
