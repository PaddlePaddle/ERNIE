...
from erniekit import version
from erniekit.common.rule import InstanceName
from erniekit.utils.util_helper import get_model_paths, save_meta_data, make_targz
from paddle.distributed.fleet.meta_optimizers.sharding.utils import add_sync_comm, save_persistables

class BaseStaticTrainerErnieGen(object):
    """BaseStaticTrainerErnie3"""
    ...
    def load_static_model_params(self, params_type, program):
