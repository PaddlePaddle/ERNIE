...
"""Finetuning on classification tasks via sequence output."""
...
from finetune.classifier_sequence import create_model, evaluate, predict
...
def main(args):
    ...
    reader = task_reader.ClassifySequenceReader(
