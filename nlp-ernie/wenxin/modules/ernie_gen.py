...
from wenxin.modules.transformer_encoder_gen import encoder, two_stream_encoder, pre_process_layer
from wenxin.modules.transformer_encoder_gen import gelu
