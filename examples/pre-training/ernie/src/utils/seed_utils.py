...
def set_seed(seed):
    ...
    # 与框架中的实现对齐, 参考：https://github.com/PaddlePaddle/Paddle/blob/f6161d1e180d76d099c59ab6d13663c2b86bbbc7/python/paddle/distributed/fleet/layers/mpu/random.py#L102
    ...
    logger.info(
        "The global seed is set to {} and local seed is set to {}. mp_init_seed={}".format(
            global_seed, local_seed, model_parallel_rng
        )
    )
