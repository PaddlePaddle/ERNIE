...
class WeightedDistributedSampler(PaddleNLPDistributedBatchSampler):
    ...
    def gen_data_seq_weighted(self, num_examples, data_type=None):
        ...
        ), "It is necessary to ensure that the data_seq for all epochs is loaded from the file, otherwise the randomness cannot be controlled when deleting the data_seq next time."
        logger.info(
