...
data_g.add_arg("predict_batch_size",  int,  32,    "Total examples' number in batch for predict. see also --in_tokens.")
...
run_type_g.add_arg("loss_scaling",                 float,  True,  "Whether to perform evaluation on test data set.")
