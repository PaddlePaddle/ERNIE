        ...
        **kwargs,
        ...
        if data_type is None:
            ...
            if pp_size > 1:
                ...
                dist.stream.all_gather(data_type_all, data_type_tensor, group=pp_group, use_calc_stream=True)
                assert (
...
def inject_vision_experts(model, optimizer):
                ...
                for key2 in ["weight", "bias"]:
                    ...
                    if key2 == "weight" and key1 == "down_proj":
                        ...
                        targe_param[target_name] = paddle.concat(
                            [up_weight[: shape[0] // 6], gate_weight[: shape[0] // 6]], axis=0
                        )
        return targe_param
    ...
    for pname in optimizer._master_weights:
        if pname_sname[pname] in v_exps:
            ...
            _varbase_help(optimizer._master_weights[pname], v_exps[pname_sname[pname]].cast("float32"))
